...
func bash_buildpack_bash() ([]byte, error) {
	return bindata_read([]byte{
		,
	},
		"bash/buildpack.bash",
	)
}
...
func bash_herokuish_bash() ([]byte, error) {
	return bindata_read([]byte{
		...
		,
	},
		"bash/herokuish.bash",
	)
}
...
func bash_procfile_bash() ([]byte, error) {
	return bindata_read([]byte{
		...
		0x28, 0xca, 0x4f, 0x4e, 0xcb, 0xcc, 0x49, 0xd5, 0x2d, 0x2e, 0x49, 0x2c,
		0x2a, 0xd1, 0xd0, 0x54, 0xa8, 0xe6, 0xe2, 0x2c, 0x29, 0x2a, 0x4d, 0xe5,
		0xaa, 0xe5, 0x42, 0xc8, 0xa5, 0x56, 0xa4, 0x26, 0xe3, 0x90, 0x2a, 0x48,
		0x2c, 0x2a, 0x4e, 0x45, 0x96, 0x03, 0x04, 0x00, 0x00, 0xff, 0xff, 0x38,
		0x27, 0x53, 0x7a, 0x52, 0x00, 0x00, 0x00,
	},
		"bash/procfile.bash",
	)
}
