...
func include_cedarish_txt() (*asset, error) {
	...
	info := bindata_file_info{name: "include/cedarish.txt", size: 3, mode: os.FileMode(420), modTime: time.Unix(1418866373, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func include_slug_bash() (*asset, error) {
	...
	info := bindata_file_info{name: "include/slug.bash", size: 1080, mode: os.FileMode(420), modTime: time.Unix(1418850311, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
