...
[![Docker Hub](https://img.shields.io/badge/docker%20hub-v0.5.16-blue)](https://hub.docker.com/r/gliderlabs/herokuish)
...
```
RUN curl --location --silent https://github.com/gliderlabs/herokuish/releases/download/v0.5.16/herokuish_0.5.16_linux_x86_64.tgz \
		  | tar -xzC /bin
```
