...
[![Docker Hub](https://img.shields.io/badge/docker%20hub-v0.11.16-blue)](https://hub.docker.com/r/gliderlabs/herokuish)
...
```shell
RUN curl --location --silent https://github.com/gliderlabs/herokuish/releases/download/v0.11.16/herokuish_0.11.16_linux_x86_64.tgz \
    | tar -xzC /bin
```
